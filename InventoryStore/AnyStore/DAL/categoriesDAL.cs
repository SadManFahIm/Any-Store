    ...
    class categoriesDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT * FROM tbl_categories1";
        ...
        public bool Insert(categoriesBLL c)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO tbl_categories1 (title, description, added_date, added_by) VALUES (@title, @description, @added_date, @added_by)";
        ...
        public bool Update(categoriesBLL c)
        {
            ...
            try
            {
                ...
                string sql = "UPDATE tbl_categories1 SET title=@title, description=@description, added_date=@added_date, added_by=@added_by WHERE id=@id";
        ...
        public bool Delete(categoriesBLL c)
        {
            ...
            try
            {
                ...
                string sql = "DELETE FROM tbl_categories1 WHERE id=@id";
        ...
        public DataTable Search(string keywords)
        {
            ...
            try
            {
                ...
                String sql = "SELECT * FROM tbl_categories1 WHERE id LIKE '%"+keywords+"%' OR title LIKE '%"+keywords+"%' OR description LIKE '%"+keywords+"%'";
